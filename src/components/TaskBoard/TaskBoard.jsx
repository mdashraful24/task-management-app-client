...
//         // Ensure category defaults to 'To-Do' if not provided
//         const taskCategory = newTask.category || 'To-Do';  // Default to 'To-Do' if not selected
...
//                     >
//                         <option value="">Select Category</option>  {/* This will allow a blank option for the user to skip selecting */}
//                         <option value="To-Do">To-Do</option>
//                         <option value="In Progress">In Progress</option>
//                         <option value="Done">Done</option>
//                     </select>
